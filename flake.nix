{
  description = "leetcode-solutions - TODO Add a description of your new project";
  ...
  outputs = inputs @ {flake-parts, ...}: let
    ...
    inherit (lib.leetcode-solutions) mapModules mkNixpkgs flatten;
    ...
    lib = nixpkgs.lib.extend (self: _super: {
      leetcode-solutions = import ./nix/lib {
  ...
  in
    flake-parts.lib.mkFlake {inherit inputs specialArgs;} {
      ...
      flake.lib = lib.leetcode-solutions;
